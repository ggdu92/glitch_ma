...
sprites.onOverlap(SpriteKind.PlayerBullet, SpriteKind.Enemy, function (sprite, otherSprite) {
    sprite.destroy(effects.spray, 750)
    ...
    if (sprites.readDataNumber(otherSprite, "Health") == 0) {
        otherSprite.destroy(effects.spray, 750)
    }
})
...
timer.after(750, function () {
    ...
    timer.after(10, function () {
        TextSprite_Back.destroy(effects.spray, 200)
        timer.background(function () {
            Textsprite_Front.destroy(effects.spray, 200)
        })
    })
})
